...
export class Start1730236366136 implements MigrationInterface {
    name = 'Start1730236366136'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`states\` (\`id\` bigint NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`name_ru\` varchar(255) NOT NULL, UNIQUE INDEX \`IDX_fe52f02449eaf27be2b2cb7acd\` (\`name\`), UNIQUE INDEX \`IDX_c33d06d3deec6fa30c298f4d91\` (\`name_ru\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`firms\` (\`id\` bigint NOT NULL AUTO_INCREMENT, \`name\` varchar(100) NOT NULL, \`ipn\` bigint NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_65cafe9027bf288960d94c7af4\` (\`name\`), UNIQUE INDEX \`IDX_5f99fae6606fbf60ee4741825f\` (\`ipn\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`products\` (\`id\` bigint NOT NULL AUTO_INCREMENT, \`code\` int NOT NULL, \`name\` varchar(255) NOT NULL, \`amount\` int NOT NULL, \`price\` int NOT NULL DEFAULT '0', \`priceold\` int NOT NULL DEFAULT '0', \`dcount\` int NOT NULL DEFAULT '0', \`dpercent\` int NOT NULL DEFAULT '0', \`pic\` varchar(255) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`firmId\` bigint NOT NULL, \`stateId\` bigint NOT NULL, \`groupId\` bigint NOT NULL, INDEX \`updatedAt-idx\` (\`updatedAt\`), UNIQUE INDEX \`IDX_7cfc24d6c24f0ec91294003d6b\` (\`code\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`IDX_c33d06d3deec6fa30c298f4d91\` ON \`states\``);
