...
export class Start1739213825014 implements MigrationInterface {
    name = 'Start1739213825014'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`states\` (\`id\` bigint NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, UNIQUE INDEX \`IDX_fe52f02449eaf27be2b2cb7acd\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`props\` (\`id\` bigint NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`orderdetails\` (\`id\` bigint NOT NULL AUTO_INCREMENT, \`code\` int NOT NULL, \`name\` varchar(255) NOT NULL, \`amount\` int NOT NULL, \`sum\` int NOT NULL, \`discount\` int NOT NULL DEFAULT '0', \`status\` enum ('0', '1', '2', '3') NOT NULL DEFAULT '0', \`comment\` varchar(255) NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`firmId\` bigint NOT NULL, \`orderId\` bigint NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`firms\` (\`id\` bigint NOT NULL AUTO_INCREMENT, \`name\` varchar(100) NOT NULL, \`ipn\` bigint NOT NULL, \`phone\` varchar(13) NOT NULL, \`email\` varchar(50) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_65cafe9027bf288960d94c7af4\` (\`name\`), UNIQUE INDEX \`IDX_5f99fae6606fbf60ee4741825f\` (\`ipn\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`categories\` (\`id\` bigint NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`ref\` varchar(255) NOT NULL, \`pic\` varchar(255) NOT NULL, UNIQUE INDEX \`IDX_8b0be371d28245da6e4f4b6187\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`groups\` (\`id\` bigint NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`ref\` varchar(255) NOT NULL, \`pic\` varchar(255) NULL, \`categoryId\` bigint NOT NULL, UNIQUE INDEX \`IDX_664ea405ae2a10c264d582ee56\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`subgroups\` (\`id\` bigint NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`ref\` varchar(255) NOT NULL, \`pic\` varchar(255) NOT NULL, \`groupId\` bigint NOT NULL, UNIQUE INDEX \`IDX_9418c3a084fb032d1795d4f0be\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`products\` (\`id\` bigint NOT NULL AUTO_INCREMENT, \`code\` int NOT NULL, \`name\` varchar(255) NOT NULL, \`amount\` int NOT NULL, \`price\` int NOT NULL DEFAULT '0', \`priceold\` int NOT NULL DEFAULT '0', \`dcount\` int NOT NULL DEFAULT '0', \`dpercent\` int NOT NULL DEFAULT '0', \`pic\` varchar(255) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`firmId\` bigint NOT NULL, \`stateId\` bigint NOT NULL, \`subgroupId\` bigint NOT NULL, INDEX \`updatedAt-idx\` (\`updatedAt\`), UNIQUE INDEX \`IDX_7cfc24d6c24f0ec91294003d6b\` (\`code\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`profiles\` (\`id\` bigint NOT NULL AUTO_INCREMENT, \`name\` varchar(50) NOT NULL, \`gender\` enum ('0', '1') NULL, \`avatar\` varchar(255) NULL, \`userId\` bigint NULL, UNIQUE INDEX \`REL_315ecd98bd1a42dcf2ec4e2e98\` (\`userId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`users\` (\`id\` bigint NOT NULL AUTO_INCREMENT, \`phone\` varchar(13) NULL, \`email\` varchar(50) NOT NULL, \`password\` varchar(255) NULL, \`active\` tinyint NOT NULL DEFAULT 0, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_a000cca60bcf04454e72769949\` (\`phone\`), UNIQUE INDEX \`IDX_97672ac88f789774dd47f7c8be\` (\`email\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`users_firms_firms\` (\`usersId\` bigint NOT NULL, \`firmsId\` bigint NOT NULL, INDEX \`IDX_df9c2da3cc3616ad2942e2c7ab\` (\`usersId\`), INDEX \`IDX_28f144cfb7f5ae63b2379a1ec7\` (\`firmsId\`), PRIMARY KEY (\`usersId\`, \`firmsId\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`subgroups\` ADD CONSTRAINT \`FK_e1da74d9e5dd6edf73ecfbd8abd\` FOREIGN KEY (\`groupId\`) REFERENCES \`groups\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`products\` ADD CONSTRAINT \`FK_edad012893f04bdc9c47ff41a20\` FOREIGN KEY (\`firmId\`) REFERENCES \`firms\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`products\` ADD CONSTRAINT \`FK_ea6ac063927174d31f4cef05fe5\` FOREIGN KEY (\`stateId\`) REFERENCES \`states\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`products\` ADD CONSTRAINT \`FK_25a925b93d0f42ad5ccb63ec22b\` FOREIGN KEY (\`subgroupId\`) REFERENCES \`subgroups\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`users_firms_firms\` ADD CONSTRAINT \`FK_df9c2da3cc3616ad2942e2c7abb\` FOREIGN KEY (\`usersId\`) REFERENCES \`users\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`users_firms_firms\` ADD CONSTRAINT \`FK_28f144cfb7f5ae63b2379a1ec72\` FOREIGN KEY (\`firmsId\`) REFERENCES \`firms\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`users_firms_firms\` DROP FOREIGN KEY \`FK_28f144cfb7f5ae63b2379a1ec72\``);
        await queryRunner.query(`ALTER TABLE \`users_firms_firms\` DROP FOREIGN KEY \`FK_df9c2da3cc3616ad2942e2c7abb\``);
        ...
        await queryRunner.query(`ALTER TABLE \`products\` DROP FOREIGN KEY \`FK_25a925b93d0f42ad5ccb63ec22b\``);
        await queryRunner.query(`ALTER TABLE \`products\` DROP FOREIGN KEY \`FK_ea6ac063927174d31f4cef05fe5\``);
        await queryRunner.query(`ALTER TABLE \`products\` DROP FOREIGN KEY \`FK_edad012893f04bdc9c47ff41a20\``);
        await queryRunner.query(`ALTER TABLE \`subgroups\` DROP FOREIGN KEY \`FK_e1da74d9e5dd6edf73ecfbd8abd\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_28f144cfb7f5ae63b2379a1ec7\` ON \`users_firms_firms\``);
        await queryRunner.query(`DROP INDEX \`IDX_df9c2da3cc3616ad2942e2c7ab\` ON \`users_firms_firms\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_9418c3a084fb032d1795d4f0be\` ON \`subgroups\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_5f99fae6606fbf60ee4741825f\` ON \`firms\``);
        await queryRunner.query(`DROP INDEX \`IDX_65cafe9027bf288960d94c7af4\` ON \`firms\``);
