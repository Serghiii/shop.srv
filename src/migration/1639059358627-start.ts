...
export class start1639059358627 implements MigrationInterface {
    name = 'start1639059358627'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`productpics\` (\`id\` bigint NOT NULL AUTO_INCREMENT, \`pic\` varchar(255) NOT NULL, \`productinfoId\` bigint NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`productpics\` ADD CONSTRAINT \`FK_c132500ea0d5a894bb6f5f5c505\` FOREIGN KEY (\`productinfoId\`) REFERENCES \`productinfo\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`productpics\` DROP FOREIGN KEY \`FK_c132500ea0d5a894bb6f5f5c505\``);
